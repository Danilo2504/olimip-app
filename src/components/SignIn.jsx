...
const SignIn=()=>{
    ...
    return <div class="content-container"><div className='sign-container'>
	<div>
		...
		<small>¿No tienes una cuenta?
			<a className='mute' href='/users/signup'>Registrate</a>
		</small>
	</div>
	<div className='sign-hero sign-in-img' alt='lasuizabiblioteca sign'></div>
</div>
</div>
}
